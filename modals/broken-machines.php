...
$query = "SELECT is_broken as broken FROM machines WHERE id = '$productID'";
$result = mysqli_query($conn, $query);
$data = $result->fetch_assoc();

if($data['broken'] == "1"){
     $sqlq  = "UPDATE machines SET is_broken=? WHERE id=?";
        ...
        // Usuwanie zdjęć
        $filename = $productID . "-3" . "-";
        $ext = ".jpg";
        $path = "../gallery/machines/";
        $path2 = "materialdb/gallery/machines/";
