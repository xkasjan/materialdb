...
//$category = 1;
//$result = $conn->query("SELECT image FROM images WHERE category = '$category' AND item_id='$imageID' ORDER BY uploaded DESC"); 

$sql = "SELECT image as img, name as nm FROM images WHERE category=? AND item_id=? ORDER BY uploaded DESC"; // SQL with parameters
