...
$sql = 
"SELECT tools.id as tid, tools.name as tname, tools.producer as tproducer, tools.model as tmodel , tools.factory_number as fnr, tools.ewidence_number as enr, tools_owner.owner as towner
FROM tools
